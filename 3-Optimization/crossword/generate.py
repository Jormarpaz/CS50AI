...
class CrosswordCreator():
    ...
    def ac3(self, arcs=None):
        ...
        """
        # Si no se dan arcos específicos, inicializar con todos los arcos posibles
        if arcs is None:
        ...
        while queue:
            x, y = queue.pop(0)  # usar lista como cola (FIFO)
            if self.revise(x, y):
                if not self.domains[x]:
                    return False  # dominio vacío => no solucionable
